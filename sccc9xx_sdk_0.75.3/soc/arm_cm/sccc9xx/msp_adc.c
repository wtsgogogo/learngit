...
void HAL_AMIC_MSP_Init()
{
    ...
    SYSC_PER->PD_PER_CLKG2 = SYSC_PER_CLKG_SET_ADC1_MASK;
	MODIFY_REG(ADC1->AMIC_CTRL, ADC_AMIC_EN_MASK|ADC_AMIC_PGA_VOL_MASK|ADC_AMIC_IBSEL_MASK,1<<ADC_AMIC_EN_POS | 0<<ADC_AMIC_PGA_VOL_POS | 1<<ADC_AMIC_IBSEL_POS);
}

void HAL_AMIC_MSP_DeInit()
{
    CLEAR_REG(ADC1->AMIC_CTRL);
    SYSC_PER->PD_PER_CLKG2 = SYSC_PER_CLKG_CLR_ADC1_MASK;

 ...
 ****************************************************************************************
 */
static inline bool co_list_is_empty(const struct co_list *const list)
{
    bool listempty;
 ...
 ****************************************************************************************
 */
static inline struct co_list_hdr *co_list_next(const struct co_list_hdr *const list_hdr)
{

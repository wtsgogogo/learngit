...
{ 
    ...
    HAL_CRYPT_DES_ECB_Encrypt(cbc_ecb_plaintext,sizeof(cbc_ecb_plaintext),ciphertext_buff,&length);    
    ...
    HAL_CRYPT_DES_ECB_Decrypt(des_ecb_ciphertext_64,sizeof(des_ecb_ciphertext_64),plaintext_buff,&length);    
    ...
    // cbc
    length = sizeof(ciphertext_buff);
    HAL_CRYPT_DES_CBC_Encrypt(cbc_iv,cbc_ecb_plaintext,sizeof(cbc_ecb_plaintext),ciphertext_buff,&length);    
    ...
    length = sizeof(plaintext_buff);
    HAL_CRYPT_DES_CBC_Decrypt(cbc_iv,des_cbc_ciphertext_64,sizeof(des_cbc_ciphertext_64),plaintext_buff,&length);    
    if (!(memcmp(cbc_ecb_plaintext, plaintext_buff, sizeof(cbc_ecb_plaintext))))
    {
...
{        
    ...
    length = sizeof(plaintext_buff);
    HAL_CRYPT_DES_ECB_Decrypt(tdes_ecb_ciphertext_128,sizeof(tdes_ecb_ciphertext_128),plaintext_buff,&length);    
    if (!(memcmp(cbc_ecb_plaintext, plaintext_buff, sizeof(cbc_ecb_plaintext))))
    {
    ...
    length = sizeof(plaintext_buff);
    HAL_CRYPT_DES_CBC_Decrypt(cbc_iv,ciphertext_buff,sizeof(ciphertext_buff),plaintext_buff,&length);    
    if (!(memcmp(cbc_ecb_plaintext, plaintext_buff, sizeof(cbc_ecb_plaintext))))
    {
...
{  
    ...
    length = sizeof(plaintext_buff);
    HAL_CRYPT_DES_ECB_Decrypt(tdes_ecb_ciphertext_192,sizeof(tdes_ecb_ciphertext_192),plaintext_buff,&length);    
    if (!(memcmp(cbc_ecb_plaintext, plaintext_buff, sizeof(cbc_ecb_plaintext))))
    {
    ...
    length = sizeof(plaintext_buff);
    HAL_CRYPT_DES_CBC_Decrypt(cbc_iv,tdes_cbc_ciphertext_192,sizeof(tdes_cbc_ciphertext_192),plaintext_buff,&length);    
    if (!(memcmp(cbc_ecb_plaintext, plaintext_buff, sizeof(cbc_ecb_plaintext))))
    {

...
enum crypt_des_type
{
    ...
    CRYPT_TDES_ECB_ENCRYPT_64,
    CRYPT_TDES_ECB_DECRYPT_64,
    CRYPT_TDES_CBC_ENCRYPT_64,
    CRYPT_TDES_CBC_DECRYPT_64,
...
volatile enum crypt_des_type crypt_des_type_flag = CRYPT_TDES_ECB_ENCRYPT_128;
...
{
    HAL_CRYPT_Block_Padding_Mode_Set(mode);
    HAL_CRYPT_DES_Key_Config(tdes_cbc_ecb_key_128,TDES_KEY_128);

    HAL_CRYPT_DES_ECB_Encrypt_IT(cbc_ecb_plaintext_aligned,sizeof(cbc_ecb_plaintext_aligned),ciphertext_buff,sizeof(ciphertext_buff));    
    while (crypt_des_type_flag == CRYPT_TDES_ECB_ENCRYPT_128);

    HAL_CRYPT_DES_ECB_Decrypt_IT(tdes_ecb_ciphertext_128_None_aligned,sizeof(tdes_ecb_ciphertext_128_None_aligned),plaintext_buff,sizeof(plaintext_buff));    
...
void crypt_ecb_test_128_PKCS7(void)
{
    ...
    HAL_CRYPT_DES_ECB_Decrypt_IT(tdes_ecb_ciphertext_128_PKCS7_aligned,sizeof(tdes_ecb_ciphertext_128_PKCS7_aligned),plaintext_buff,sizeof(plaintext_buff));    
    while (crypt_des_type_flag == CRYPT_TDES_ECB_DECRYPT_128);
}
...
void crypt_ecb_test_128_ANSIX923(void)
{
    ...
    HAL_CRYPT_DES_ECB_Decrypt_IT(tdes_ecb_ciphertext_128_ANSIX923_aligned,sizeof(tdes_ecb_ciphertext_128_ANSIX923_aligned),plaintext_buff,sizeof(plaintext_buff));    
    while (crypt_des_type_flag == CRYPT_TDES_ECB_DECRYPT_128);
}
...
void crypt_ecb_test_128_ISO7816(void)
{
    ...
    HAL_CRYPT_DES_ECB_Decrypt_IT(tdes_ecb_ciphertext_128_ISO7816_aligned,sizeof(tdes_ecb_ciphertext_128_ISO7816_aligned),plaintext_buff,sizeof(plaintext_buff));    
    while (crypt_des_type_flag == CRYPT_TDES_ECB_DECRYPT_128);
}
...
void crypt_ecb_test_128_ISO10126(void)
{
    ...
    HAL_CRYPT_DES_ECB_Decrypt_IT(ciphertext_buff,sizeof(ciphertext_buff),plaintext_buff,sizeof(plaintext_buff));    
    while (crypt_des_type_flag == CRYPT_TDES_ECB_DECRYPT_128);
}

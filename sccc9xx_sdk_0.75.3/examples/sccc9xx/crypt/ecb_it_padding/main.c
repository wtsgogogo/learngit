...
void crypt_cbc_ecb_test_128_None(void)
{
    ...
    HAL_CRYPT_AES_ECB_Encrypt_IT(cbc_ecb_plaintext_aligned, sizeof(cbc_ecb_plaintext_aligned), ciphertext_buff, sizeof(ciphertext_buff));
    while (crypt_type_flag == CRYPT_ECB_ENCRYPT_128);

    HAL_CRYPT_AES_ECB_Decrypt_IT(ecb_ciphertext_128_None_aligned, sizeof(ecb_ciphertext_128_None_aligned), plaintext_buff,sizeof(plaintext_buff));
...
void crypt_cbc_ecb_test_128_PKCS7(void)
{
    ...
    HAL_CRYPT_AES_ECB_Decrypt_IT(ecb_ciphertext_128_PKCS7_aligned, sizeof(ecb_ciphertext_128_PKCS7_aligned), plaintext_buff,sizeof(plaintext_buff));
    while (crypt_type_flag == CRYPT_ECB_DECRYPT_128);
}
...
void crypt_cbc_ecb_test_128_ANSIX923(void)
{
    ...
    HAL_CRYPT_AES_ECB_Decrypt_IT(ecb_ciphertext_128_ANSIX923_aligned, sizeof(ecb_ciphertext_128_ANSIX923_aligned), plaintext_buff,sizeof(plaintext_buff));
    while (crypt_type_flag == CRYPT_ECB_DECRYPT_128);
}
...
void crypt_cbc_ecb_test_128_ISO7816(void)
{
    ...
    HAL_CRYPT_AES_ECB_Decrypt_IT(ecb_ciphertext_128_ISO7816_aligned, sizeof(ecb_ciphertext_128_ISO7816_aligned), plaintext_buff,sizeof(plaintext_buff));
    while (crypt_type_flag == CRYPT_ECB_DECRYPT_128);
}
...
void crypt_cbc_ecb_test_128_ISO10126(void)
{
    ...
    HAL_CRYPT_AES_ECB_Decrypt_IT(ciphertext_buff, sizeof(ciphertext_buff), plaintext_buff,sizeof(plaintext_buff));
    while (crypt_type_flag == CRYPT_ECB_DECRYPT_128);
}

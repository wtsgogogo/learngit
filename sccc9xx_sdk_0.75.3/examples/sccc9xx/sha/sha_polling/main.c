...
static void sha_crypt_test(void)
{
    ...
    HAL_SHA_SHA256(plaintext, sizeof(plaintext), cipherbuffer_sha256);
    ...
    HAL_SHA_SHA224(plaintext,sizeof(plaintext),cipherbuffer_sha224);
    ...
    HAL_SHA_SM3(plaintext, sizeof(plaintext), cipherbuffer_sm3);

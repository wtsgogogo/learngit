...
{
    HAL_SHA_SHA256_IT(plaintext, sizeof(plaintext), cipherbuffer_sha256);
    while (flag == SHA256_ENCRYPT);
    
    HAL_SHA_SHA224_IT(plaintext, sizeof(plaintext), cipherbuffer_sha224);
...
void HAL_SHA_SHA256_Complete_Callback()
{
...
void HAL_SHA_SHA224_Complete_Callback()
{

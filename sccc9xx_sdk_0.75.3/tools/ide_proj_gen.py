...
if __name__ == '__main__':
    ...
    le501x_proj_gen('examples/peripheral/ecc/ecdh_it')
    le501x_proj_gen('examples/peripheral/ecc/ecdh_polling')
    ...
    le501x_proj_gen('examples/peripheral/pdm/pdm_pingpong_dma')
    le501x_proj_gen('examples/peripheral/pdm/pdm_it')
    ...
    lm3050_proj_gen('examples/peripheral/ecc/ecdh_it')
    lm3050_proj_gen('examples/peripheral/ecc/ecdh_polling')
    ...
    lm3050_proj_gen('examples/peripheral/pdm/pdm_it')

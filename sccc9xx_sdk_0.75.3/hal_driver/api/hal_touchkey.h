#ifndef HAL_TOUCHKEY_H_
#define HAL_TOUCHKEY_H_
#include <stdbool.h>
#include <stdint.h>
#include "HAL_def.h"
...
/**
 * @brief TOUCHKEY set up parameters
 *
...
/**
 * @brief TOUCHKEY StartScan (Interrupt Mode)
 * @return HAL_StatusTypeDef
 */

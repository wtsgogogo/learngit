...
/** \brief CRYPT AES ECB Decrypt (Block Mode)
...
/** \brief CRYPT AES CBC Encrypt (Block Mode)
...
/** \brief CRYPT AES CBC Decrypt (Block Mode)
 *  \param[in] iv Initial vector
 *  \param[in] ciphertext Input data
 *  \param[in] ciphertextlength Input data Length
 *  \param[out] plaintext Output data
...
/** \brief CRYPT AES ECB Encrypt (Interrupt Mode)
 *  \param[in] plaintext Input data
 *  \param[in] plaintextlength Input data Length
 *  \param[out] ciphertext Output data
...
/** \brief CRYPT AES ECB Decrypt (Interrupt Mode)
 *  \param[in] ciphertext Input data
 *  \param[in] ciphertextlength Input data Length
 *  \param[out] plaintext Output data
...
/** \brief CRYPT AES CBC Encrypt (Interrupt Mode)
 *  \param[in] iv Initial vector
 *  \param[in] plaintext Input data
 *  \param[in] plaintextlength Input data Length
 *  \param[out] ciphertext Output data
...
/** \brief CRYPT AES CBC Decrypt (Interrupt Mode)
 *  \param[in] iv Initial vector
 *  \param[in] ciphertext Input data
 *  \param[in] ciphertextlength Input data Length
 *  \param[out] plaintext Output data
...
/** \brief CRYPT DES ECB Encrypt (Block Mode)
 *  \param[in] plaintext Input data
 *  \param[in] plaintextlength Input data Length
 *  \param[out] ciphertext Output data
 *  \param[inout] ciphertextlength in: Size of the ciphertext buffer; out: Output data Length
...
/** \brief CRYPT DES ECB Decrypt (Block Mode)
 *  \param[in] ciphertext Input data
 *  \param[in] ciphertextlength Input data Length
 *  \param[out] plaintext Output data
 *  \param[inout] plaintextlength in: Size of the plaintext buffer; out: Output data Length
...
/** \brief CRYPT DES CBC Encrypt (Block Mode)
 *  \param[in] iv Initial vector
 *  \param[in] plaintext Input data
 *  \param[in] plaintextlength Input data Length
 *  \param[out] ciphertext Output data
...
/** \brief CRYPT DES CBC Decrypt (Block Mode)
 *  \param[in] iv Initial vector
 *  \param[in] ciphertext Input data
 *  \param[in] ciphertextlength Input data Length
 *  \param[out] plaintext Output data
...
/** \brief CRYPT DES ECB Encrypt (Interrupt Mode)
 *  \param[in] plaintext Input data
 *  \param[in] plaintextlength Input data Length
 *  \param[out] ciphertext Output data
 *  \param[in] ciphertextlength Size of the ciphertext buffer
...
/** \brief CRYPT DES ECB Decrypt (Interrupt Mode)
 *  \param[in] ciphertext Input data
 *  \param[in] ciphertextlength Input data Length
 *  \param[out] plaintext Output data
 *  \param[in] plaintextlength Size of the plaintext buffer
...
/** \brief CRYPT DES CBC Encrypt (Interrupt Mode)
 *  \param[in] iv Initial vector
 *  \param[in] plaintext Input data
 *  \param[in] plaintextlength Input data Length
 *  \param[out] ciphertext Output data
...
/** \brief CRYPT DES CBC Decrypt (Interrupt Mode)
 *  \param[in] iv Initial vector
 *  \param[in] ciphertext Input data
 *  \param[in] ciphertextlength Input data Length
 *  \param[out] plaintext Output data
...
void HAL_CRYPT_IRQHandler(void);

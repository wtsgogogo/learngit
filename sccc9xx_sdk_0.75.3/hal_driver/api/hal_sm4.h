...
/**
 * @brief SM4 De-Initialize
 * @return HAL_StatusTypeDef 
 */
HAL_StatusTypeDef HAL_SM4_DeInit(void);

/**
 * @brief SM4 KeyExpansion
 * 
...
/**
 * @brief SM4 KeyExpansion (Interrupt Mode)
 * 
...
/**
 * @brief SM4 Encrypt (Interrupt Mode)
 * 
 * @param data Intput data
 * @param result Output data
 * @param length the length of Intput data，Must be 16 byte aligned
...
/**
 * @brief SM4 Decrypt (Interrupt Mode)
 * 
 * @param data Intput data
 * @param result Output data
 * @param length the length of Intput data，Must be 16 byte aligned

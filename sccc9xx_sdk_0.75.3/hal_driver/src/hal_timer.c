...
HAL_StatusTypeDef HAL_TIM_Init(TIM_HandleTypeDef *htim)
{
  ...
  ASSERT(IS_TIM_COUNTER_MODE(htim->Init.CounterMode));
  ASSERT(IS_TIM_CLOCKDIVISION_DIV(htim->Init.ClockDivision));
  ASSERT(IS_TIM_AUTORELOAD_PRELOAD(htim->Init.AutoReloadPreload));
  ASSERT(IS_TIM_TRGO_SOURCE(htim->Init.TrgoSource));
...
HAL_StatusTypeDef HAL_TIM_OC_Start(TIM_HandleTypeDef *htim, uint32_t Channel)
{
  ...
  /* Check the parameters */
  ASSERT(IS_TIM_CCX_INSTANCE(htim->Instance, Channel));
...
{
  ASSERT(IS_TIM_OPM_MODE(OnePulseMode));
...
{
  /* Check the parameters */
  ASSERT(IS_TIM_CHANNELS(Channel));
  ASSERT(IS_TIM_OC_MODE(sConfig->OCMode));
  ASSERT(IS_TIM_OC_POLARITY(sConfig->OCPolarity));
  ...
  switch (Channel)
  {
    ...
    {
      /* Check the parameters */
      ASSERT(IS_TIM_CC1_INSTANCE(htim->Instance));
    ...
    {
      /* Check the parameters */
      ASSERT(IS_TIM_CC2_INSTANCE(htim->Instance));
    ...
    {
      /* Check the parameters */
      ASSERT(IS_TIM_CC3_INSTANCE(htim->Instance));
    ...
    {
      /* Check the parameters */
      ASSERT(IS_TIM_CC4_INSTANCE(htim->Instance));
...
HAL_StatusTypeDef HAL_TIM_IC_ConfigChannel(TIM_HandleTypeDef *htim, TIM_IC_InitTypeDef *sConfig, uint32_t Channel)
{
  /* Check the parameters */
  ASSERT(IS_TIM_CC1_INSTANCE(htim->Instance));
  ASSERT(IS_TIM_IC_POLARITY(sConfig->ICPolarity));
  ASSERT(IS_TIM_IC_SELECTION(sConfig->ICSelection));
  ASSERT(IS_TIM_IC_PRESCALER(sConfig->ICPrescaler));
  ASSERT(IS_TIM_IC_FILTER(sConfig->ICFilter));
...
HAL_StatusTypeDef HAL_TIM_PWM_ConfigChannel(TIM_HandleTypeDef *htim,TIM_OC_InitTypeDef *sConfig,uint32_t Channel)
{
  /* Check the parameters */
  ASSERT(IS_TIM_CHANNELS(Channel));
  ASSERT(IS_TIM_PWM_MODE(sConfig->OCMode));
  ASSERT(IS_TIM_OC_POLARITY(sConfig->OCPolarity));
  ASSERT(IS_TIM_FAST_STATE(sConfig->OCFastMode));
...
HAL_StatusTypeDef HAL_TIM_GenerateEvent(TIM_HandleTypeDef *htim, uint32_t EventSource)
{
  ...
  ASSERT(IS_TIM_EVENT_SOURCE(EventSource));
...
{
  /* Check the parameters */
  ASSERT(IS_TIM_OCXREF_CLEAR_INSTANCE(htim->Instance));
  ASSERT(IS_TIM_CLEARINPUT_SOURCE(sClearInputConfig->ClearInputSource));
  ...
  switch (sClearInputConfig->ClearInputSource)
  {
    ...
    {
      /* Check the parameters */
      ASSERT(IS_TIM_CLEARINPUT_POLARITY(sClearInputConfig->ClearInputPolarity));
      ASSERT(IS_TIM_CLEARINPUT_PRESCALER(sClearInputConfig->ClearInputPrescaler));
      ASSERT(IS_TIM_CLEARINPUT_FILTER(sClearInputConfig->ClearInputFilter));
...
HAL_StatusTypeDef HAL_TIM_ConfigClockSource(TIM_HandleTypeDef *htim, TIM_ClockConfigTypeDef *sClockSourceConfig)
{
  ...
  /* Check the parameters */
  ASSERT(IS_TIM_CLOCKSOURCE(sClockSourceConfig->ClockSource));
  ...
  switch (sClockSourceConfig->ClockSource)
  {
    ...
    case TIM_CLOCKSOURCE_ETRMODE1:
    {
      ...
      ASSERT(IS_TIM_CLOCKSOURCE_ETRMODE1_INSTANCE(htim->Instance));

      /* Check ETR input conditioning related parameters */
      ASSERT(IS_TIM_CLOCKPRESCALER(sClockSourceConfig->ClockPrescaler));
      ASSERT(IS_TIM_CLOCKPOLARITY(sClockSourceConfig->ClockPolarity));
      ASSERT(IS_TIM_CLOCKFILTER(sClockSourceConfig->ClockFilter));
    ...
    case TIM_CLOCKSOURCE_ETRMODE2:
    {
      ...
      ASSERT(IS_TIM_CLOCKSOURCE_ETRMODE2_INSTANCE(htim->Instance));
    ...
    case TIM_CLOCKSOURCE_TI1:
    {
      ...
      ASSERT(IS_TIM_CLOCKSOURCE_TIX_INSTANCE(htim->Instance));
    ...
    case TIM_CLOCKSOURCE_ITR3:
    {
      ...
      ASSERT(IS_TIM_CLOCKSOURCE_ITRX_INSTANCE(htim->Instance));
...
HAL_StatusTypeDef HAL_TIM_ConfigTI1Input(TIM_HandleTypeDef *htim, uint32_t TI1_Selection)
{
  ...
  /* Check the parameters */
  ASSERT(IS_TIM_XOR_INSTANCE(htim->Instance));
  ASSERT(IS_TIM_TI1SELECTION(TI1_Selection));
...
void TIM_OC1_SetConfig(reg_timer_t *TIMx, TIM_OC_InitTypeDef *OC_Config)
{
  ...
  {
    /* Check parameters */
    ASSERT(IS_TIM_OCN_POLARITY(OC_Config->OCNPolarity));
  ...
  {
    /* Check parameters */
    ASSERT(IS_TIM_OCNIDLE_STATE(OC_Config->OCNIdleState));
    ASSERT(IS_TIM_OCIDLE_STATE(OC_Config->OCIdleState));
...
static HAL_StatusTypeDef TIM_SlaveTimer_SetConfig(TIM_HandleTypeDef *htim, TIM_SlaveConfigTypeDef *sSlaveConfig)
{
  ...
  switch (sSlaveConfig->InputTrigger)
  {
    case TIM_TS_ETRF:
    {
      /* Check the parameters */
      ASSERT(IS_TIM_CLOCKSOURCE_ETRMODE1_INSTANCE(htim->Instance));
      ASSERT(IS_TIM_TRIGGERPRESCALER(sSlaveConfig->TriggerPrescaler));
      ASSERT(IS_TIM_TRIGGERPOLARITY(sSlaveConfig->TriggerPolarity));
      ASSERT(IS_TIM_TRIGGERFILTER(sSlaveConfig->TriggerFilter));
...
{
  /* Check the parameters */
  ASSERT(IS_TIM_SLAVE_INSTANCE(htim->Instance));
  ASSERT(IS_TIM_SLAVE_MODE(sSlaveConfig->SlaveMode));
  ASSERT(IS_TIM_TRIGGER_SELECTION(sSlaveConfig->InputTrigger));
...
void TIM_CCxChannelCmd(reg_timer_t *TIMx, uint32_t Channel, uint32_t ChannelState)
{
  ...
  /* Check the parameters */
  ASSERT(IS_TIM_CC1_INSTANCE(TIMx));
  ASSERT(IS_TIM_CHANNELS(Channel));
...
HAL_StatusTypeDef HAL_TIMEx_OCN_Start(TIM_HandleTypeDef *htim, uint32_t Channel)
{
  ...
  /* Check the parameters */
  ASSERT(IS_TIM_CCXN_INSTANCE(htim->Instance, Channel));
                                                ...
                                                TIM_BreakDeadTimeConfigTypeDef *sBreakDeadTimeConfig)
{
  ...
  /* Check the parameters */
  ASSERT(IS_TIM_BREAK_INSTANCE(htim->Instance));
  ASSERT(IS_TIM_OSSR_STATE(sBreakDeadTimeConfig->OffStateRunMode));
  ASSERT(IS_TIM_OSSI_STATE(sBreakDeadTimeConfig->OffStateIDLEMode));
  ASSERT(IS_TIM_LOCK_LEVEL(sBreakDeadTimeConfig->LockLevel));
  ASSERT(IS_TIM_DEADTIME(sBreakDeadTimeConfig->DeadTime));
  ASSERT(IS_TIM_BREAK_STATE(sBreakDeadTimeConfig->BreakState));
  ASSERT(IS_TIM_BREAK_POLARITY(sBreakDeadTimeConfig->BreakPolarity));
  ASSERT(IS_TIM_AUTOMATIC_OUTPUT_STATE(sBreakDeadTimeConfig->AutomaticOutput));
...
HAL_StatusTypeDef HAL_TIM_Encoder_Init(TIM_HandleTypeDef *htim,  TIM_Encoder_InitTypeDef *sConfig)
{
  ...
  ASSERT(IS_TIM_AUTORELOAD_PRELOAD(htim->Init.AutoReloadPreload));
  ASSERT(IS_TIM_CC2_INSTANCE(htim->Instance));
  ASSERT(IS_TIM_ENCODER_MODE(sConfig->EncoderMode));
  ASSERT(IS_TIM_IC_SELECTION(sConfig->IC1Selection));
  ASSERT(IS_TIM_IC_SELECTION(sConfig->IC2Selection));
  ASSERT(IS_TIM_IC_POLARITY(sConfig->IC1Polarity));
  ASSERT(IS_TIM_IC_POLARITY(sConfig->IC2Polarity));
  ASSERT(IS_TIM_IC_PRESCALER(sConfig->IC1Prescaler));
  ASSERT(IS_TIM_IC_PRESCALER(sConfig->IC2Prescaler));
  ASSERT(IS_TIM_IC_FILTER(sConfig->IC1Filter));
  ASSERT(IS_TIM_IC_FILTER(sConfig->IC2Filter));

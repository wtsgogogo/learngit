...
#define GLOBAL_BLOCK_UNLOCK_OPCODE 0x98
#define GLOBAL_BLOCK_LOCK_OPCODE 0x7e
#define READ_BLOCK_LOCK_STATUS_OPCODE 0x3d
#define INDIVIDUAL_BLOCK_UNLOCK_OPCODE 0x39
#define INDIVIDUAL_BLOCK_LOCK_OPCODE 0x36
